...
## Acknowledgment
Thanks to the original author for their open-source work. This project is modified from [astro-theme-cactus](https://github.com/chrismwilliams/astro-theme-cactus).
Part of the inspiration also comes from [kirontoo/astro-theme-cody](https://github.com/kirontoo/astro-theme-cody).
